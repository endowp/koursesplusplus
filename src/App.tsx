  ...
  return (
    <div className="App">
      <header className="App-header px-5">
        ...
        <h5>
          แหล่งรวมคอร์และเว็บไซต์สำหรับการเรียนแบบออนไลน์
      ...
      <div className="App-footer">
        ...
        <div>
          Kourses++
          สร้างขึ้นเพื่อเป็นการขอบคุณแก่แพลตฟอร์มเรียนออนไลน์ฟรีทั่วโลก
          ที่เปิดโอกาสให้ผู้คนได้เรียนรู้ พัฒนาทักษะ และทำตามความฝันจนสำเร็จ
